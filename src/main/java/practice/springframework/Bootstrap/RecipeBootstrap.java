package practice.springframework.Bootstrap;

import lombok.extern.slf4j.Slf4j;
import org.springframework.context.ApplicationListener;
import org.springframework.context.event.ContextRefreshedEvent;
import org.springframework.stereotype.Component;
import practice.springframework.Models.*;
import practice.springframework.Repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.setSource("Source 2");
        ...
        tacoNote.setRecipeNote("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
